...
function displayPastDodgersWins() {
  //display the past Dodger Wins at Home with a score of 6 or more, since the beginning of the Panda Express plate promotion (May 2024)
}

function displayUpcomingDodgersHomeGames() {}
